...
<html>
    ...
    <body class="font-[Poppins] bg-[#fff]  to- min-h-screen flex flex-col overflow-x-hidden">
                    ...
                    <ul class="flex md:flex-row flex-col items-end md:items-center md:gap-[2vw] gap-8">
                        <li class="relative group">
                            <a class="hover:text-[#ffc451] text-white"
                                href="#">Customer</a>
                            <ul
                                class="absolute hidden bg-neutral-700 text-white mt-2 py-2 rounded-md w-[150px] top-[50%] group-hover:block transition-opacity duration-300 ease-in-out">
        ...
        <footer
            class="footer h-5 bottom-0 left-0 z-20 w-full p-4 bg-[#292929] border-t border-gray-200 shadow md:flex md:items-center md:justify-between md:p-6 dark:bg-gray-800 dark:border-gray-600">
            <div class="mx-auto text-sm text-gray-500 sm:text-center text-white">
                © Copyright <a href="https://MutualGlobal.com/"
                    class="hover:underline"
                    target="new">MutualGlobal.com</a>. All Rights Reserved.
            </div>
        </footer>
