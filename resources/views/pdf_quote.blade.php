...
<body>
  <div>
    ...
    <img src="{{ asset('images/pdf/logo.png') }}" alt="..." style="width: 60%; position: absolute; top: -20px; left: 75%; transform: translateX(-50%); z-index: 2;">
    <img src="{{ asset('images/pdf/yellow1.png') }}" alt="..." style="width: 55%; height: 80%;  position: absolute; top: 10%; left: -50px; z-index: 1;">
    ...
    <!-- Qr Image  -->
    <img src="{{ asset('images/pdf/qr.png') }}" alt="..." style="width: 60%; position: absolute; margin-top:15rem; left: 70%; transform: translateX(-50%); z-index: 1;">
    <!-- Text inside QR image -->
    <div style="width: 60%; position: absolute; margin-top:16rem; left: 73%; transform: translateX(-50%); z-index: 2;">
      ...
      <div style="display: inline-block;margin-top:5px;">
        Like us at:
        <img src="{{ asset('images/pdf/facebook.png') }}" alt="Facebook" width="15" height="15" style="margin-bottom: -3px;">
        <img src="{{ asset('images/pdf/twitter.png') }}" alt="Twitter" width="15" height="15" style="margin-bottom: -3px;">
      </div><br>

      <div style="display: inline-block; margin-top:5px;">
        Search us at :
        <img src="{{ asset('images/pdf/google.png') }}" alt="Google" width="30" height="30" style="margin-bottom: -10px;">
      </div>
    ...
    <!-- Footer -->
    <div style="text-align: center;font-size: 12px; background-color: black; color:white; position: absolute; left: -46px; bottom:-46px; width: 50rem;">
      <strong>Mutual Global Insurance Broking Pvt Ltd, (Licence No : 752, Licence period 01/07/2021 to 30/06/2024), 2nd Floor, 16/1, AVS Compound,<br>
        80ft Road, 4th Block, Koramangala, Bangalore 560034, An ISO Certified Company (ISO 9001:2015 Certificate No 22IQKS27)
      </strong>
    </div>
  ...
  <table class="page-break" style="border-collapse: collapse;  width:100%;">
    <tbody>
      <tr>
      ...
      <tr>
        <td colspan="4" style="border: 0; height: 20px !important;"></td>
      </tr>
    </tbody>
    ...
    <tr>
      <th colspan="4" style=" background: #F7B610; color: white; text-align: left;"><strong>{{ $productSectionName[3] }}</strong></th>
    </tr>
    <tr>
