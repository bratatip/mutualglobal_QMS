...
@section('content')
    ...
    @endif
    {{ Breadcrumbs::render('edit', $customer->id) }}
        ...
        <div class="flex flex-wrap -mx-4 mb-6 p-6 max-md:p-2 bg-zinc-100 border border-solid shadow-2xl rounded-2xl">
            <form action="{{ route('customer.update', $customer->id) }}"
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        <label for="customerName"
                               class=" text-[#0F628B]">Customer Name <span class="required-field">*</span> </label>
                        <input type="text"
                    ...
                    <div class="form-group col-md-6">
                        <label for="customerAddress"
                               class="text-[#0F628B]">Customer Mailing Address <span class="required-field">*</span></label>
                        <textarea class="h-8 underline-input custom-textarea bg-white dark:bg-gray-800 overflow-hidden shadow sm:rounded-lg text-gray-500 text-xs"
                                  name="address"
                                  id="customerAddress"
                                  rows="2"
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        <label for="pin"
                               class="text-[#0F628B]">Pin <span class="required-field">*</span></label>
                        <input type="text"
                               class="h-8 underline-input bg-white dark:bg-gray-800 overflow-hidden shadow sm:rounded-lg text-gray-500 text-xs"
                               name="zip_code"
                               id="pin"
                    ...
                    <div class="form-group col-md-6">
                        <label for="email"
                               class="text-[#0F628B]">Email <span class="required-field">*</span></label>
                        <input type="email"
                               class="h-8 underline-input bg-white dark:bg-gray-800 overflow-hidden shadow sm:rounded-lg text-gray-500 text-xs"
                               name="email"
                               id="email"
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        <label for="contact"
                               class="text-[#0F628B]">Contact No. <span class="required-field">*</span></label>
                        <input type="text"
                               class="h-8 underline-input bg-white dark:bg-gray-800 overflow-hidden shadow sm:rounded-lg text-gray-500 text-xs"
                    ...
                    <div class="form-group col-md-6">
                        <label for="contactPerson"
                               class="text-[#0F628B]">Contact Person <span class="required-field">*</span></label>
                        <input type="text"
                               class="h-8 underline-input bg-white dark:bg-gray-800 overflow-hidden shadow sm:rounded-lg text-gray-500 text-xs"
